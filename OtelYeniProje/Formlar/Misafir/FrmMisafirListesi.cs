...
using OtelYeniProje.Formlar.Personel;
using System;
...
namespace OtelYeniProje.Formlar.Misafir
{
    public partial class FrmMisafirListesi : Form
    {
        ...
        {
            gridControl1.DataSource = (from x in db.TblMisafir select new {x.MisafirID,x.AdSoyad, x.TC, x.Telefon, x.Mail,
              x.iller.sehir, x.ilceler.ilce
            }).ToList();
        }
